...
from src.algorithms import structural_holes
...
class MRJobStructuralHoles(MRJob):
    ...
    def configure_options(self):
        ...
        self.add_passthru_arg('--wholeNetwork', type='int', default=1, help='Should this be computed across the whole network <structural-holes>')
        self.add_passthru_arg('--messure', type='string', default="strutural-holes", help='which messur to run, brokerage or strutural-holes')
        self.add_passthru_arg('--includeOutLinks', type='int', default=1, help='for structural holes should outlinks be included')
        self.add_passthru_arg('--includeInLinks', type='int', default=0, help='for structural holes should outlinks be included')
        self.add_passthru_arg('--partition', type='string', default="group", help='the attribute in for each node which represents group membership')
